...
await ws.sendAndValidate(
    {
        ...
        "args": {"profile_id": 1, "caption": "develop"},
    },
    [
        {
            "request_state": {"type": "PENDING", "msg": ""},
...
await ws.sendAndValidate(
    {
        ...
        "args": {"folder_path_id": ws.tokens["sub_develop_folder_path_id"]},
    },
    [
        {
            "request_id": ws.lastGeneratedRequestId,
...
await ws.sendAndValidate(
    {
        ...
        "request_id": ws.generateRequestId(),
        "command": "gui.db_connections.remove_folder_path",
        "args": {"folder_path_id": ws.tokens["develop_folder_path_id"]},
    },
    [
        {
            "request_id": ws.lastGeneratedRequestId,
...
await ws.sendAndValidate(
    {
        ...
        "request_id": ws.generateRequestId(),
        "command": "gui.db_connections.remove_folder_path",
        "args": {"folder_path_id": ws.tokens["test_folder_path_id"]},
    },
    [
        {
            "request_id": ws.lastGeneratedRequestId,
...
await ws.sendAndValidate(
    {
        ...
        "args": {
            ...
            "connection": {
                ...
                "options": {"uri": "mysql://user@localhost:3306/test"},
            },
        },
    },
    [
...
await ws.sendAndValidate(
    {
        ...
        "args": {"profile_id": 1, "folder_id": ws.tokens["recursive_folder_id"]},
    },
    [
        {
            "request_state": {"type": "PENDING", "msg": ""},
...
await ws.sendAndValidate(
    {
        ...
        "args": {"profile_id": 1, "connection_id": ws.tokens["test_connection_id"]},
    },
    [
        {
            "request_id": ws.lastGeneratedRequestId,
...
await ws.sendAndValidate(
    {
        ...
        "request_id": ws.generateRequestId(),
        "command": "gui.db_connections.remove_folder_path",
        "args": {"folder_path_id": ws.tokens["subsub_recursive1_id"]},
    },
    [
        {
            "request_id": ws.lastGeneratedRequestId,
...
await ws.sendAndValidate(
    {
        ...
        "request_id": ws.generateRequestId(),
        "command": "gui.db_connections.remove_folder_path",
        "args": {"folder_path_id": ws.tokens["sub_recursive1_id"]},
    },
    [
        {
            "request_id": ws.lastGeneratedRequestId,
...
await ws.sendAndValidate(
    {
        ...
        "request_id": ws.generateRequestId(),
        "command": "gui.db_connections.remove_folder_path",
        "args": {"folder_path_id": ws.tokens["recursive_folder_id"]},
    },
    [
        {
            "request_id": ws.lastGeneratedRequestId,
