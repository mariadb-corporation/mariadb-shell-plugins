...
export default defineConfig(({ mode }) => {
    return {
        plugins: [
            ...
            // @ts-expect-error, because TS does not correctly type this plugin.
        ...
        define: {
            ...
            "globalThis.MSG_VERSION_NUMBER": `"${packageData.version}"`,
            "globalThis.VITE_MODE": JSON.stringify(mode),
        },
        resolve: {
            alias: {
