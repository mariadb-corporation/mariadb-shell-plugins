...
export const dbConnectionDialog = {
    ...
    mysql: {
        ...
        advanced: {
            sqlModeItem: {
                ansi: By.id("Ansi"),
                traditional: By.id("Traditional"),
                allowInvalidDates: By.id("AllowInvalidDates"),
                ansiQuotes: By.id("AnsiQuotes"),
                errorForDivisionByZero: By.id("ErrorForDivisionByZero"),
                highNotPrecedence: By.id("HighNotPrecedence"),
                ignoreSpace: By.id("IgnoreSpace"),
                noAutoValueOnZero: By.id("NoAutoValueOnZero"),
                noUnsignedSubtraction: By.id("NoUnsignedSubtraction"),
                noZeroDate: By.id("NoZeroDate"),
                noZeroInDate: By.id("NoZeroInDate"),
                onlyFullGroupBy: By.id("OnlyFullGroupBy"),
                padCharToFullLength: By.id("PadCharToFullLength"),
                pipesAsConcat: By.id("PipesAsConcat"),
                realAsFloat: By.id("RealAsFloat"),
                strictAllTables: By.id("StrictAllTables"),
                strictTransTables: By.id("StrictTransTables"),
                timeTruncateFractional: By.id("TimeTruncateFractional"),
            },
