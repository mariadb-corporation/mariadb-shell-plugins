...
"""The MariaDB Shell Migration Plugin"""
...
@plugin_function("migration.info", shell=True, cli=False, web=True)
def info() -> str:
...
@plugin_function("migration.version", shell=True, cli=False, web=True)
def version() -> str:
