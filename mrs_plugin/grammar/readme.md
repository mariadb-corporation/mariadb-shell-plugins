...
The MariaDB Shell includes a specific version of the ANTLR Python runtime, e.g. 4.13.0. It is important to use that very same version of ANTLR to generate the Python files found in the ../mrs_parser folder.
