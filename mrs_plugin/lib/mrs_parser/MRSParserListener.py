...
class MRSParserListener(ParseTreeListener):
    ...
    def enterServiceSchemaSelectorWildcard(
        self, ctx: MRSParser.ServiceSchemaSelectorWildcardContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#serviceSchemaSelectorWildcard.
    def exitServiceSchemaSelectorWildcard(
        self, ctx: MRSParser.ServiceSchemaSelectorWildcardContext
    ):
        pass
    ...
    def enterConfigureRestMetadataStatement(
        self, ctx: MRSParser.ConfigureRestMetadataStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#configureRestMetadataStatement.
    def exitConfigureRestMetadataStatement(
        self, ctx: MRSParser.ConfigureRestMetadataStatementContext
    ):
        pass
    ...
    def enterCreateRestServiceStatement(
        self, ctx: MRSParser.CreateRestServiceStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestServiceStatement.
    def exitCreateRestServiceStatement(
        self, ctx: MRSParser.CreateRestServiceStatementContext
    ):
        pass
    ...
    def enterCreateRestSchemaStatement(
        self, ctx: MRSParser.CreateRestSchemaStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestSchemaStatement.
    def exitCreateRestSchemaStatement(
        self, ctx: MRSParser.CreateRestSchemaStatementContext
    ):
        pass
    ...
    def enterCreateRestViewStatement(
        self, ctx: MRSParser.CreateRestViewStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestViewStatement.
    def exitCreateRestViewStatement(
        self, ctx: MRSParser.CreateRestViewStatementContext
    ):
        pass
    ...
    def enterRestViewAuthenticationProcedure(
        self, ctx: MRSParser.RestViewAuthenticationProcedureContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#restViewAuthenticationProcedure.
    def exitRestViewAuthenticationProcedure(
        self, ctx: MRSParser.RestViewAuthenticationProcedureContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#createRestProcedureStatement.
    def enterCreateRestProcedureStatement(
        self, ctx: MRSParser.CreateRestProcedureStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestProcedureStatement.
    def exitCreateRestProcedureStatement(
        self, ctx: MRSParser.CreateRestProcedureStatementContext
    ):
        pass
    ...
    def enterCreateRestFunctionStatement(
        self, ctx: MRSParser.CreateRestFunctionStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestFunctionStatement.
    def exitCreateRestFunctionStatement(
        self, ctx: MRSParser.CreateRestFunctionStatementContext
    ):
        pass
    ...
    def enterCreateRestContentSetStatement(
        self, ctx: MRSParser.CreateRestContentSetStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestContentSetStatement.
    def exitCreateRestContentSetStatement(
        self, ctx: MRSParser.CreateRestContentSetStatementContext
    ):
        pass
    ...
    def enterCreateRestContentFileStatement(
        self, ctx: MRSParser.CreateRestContentFileStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestContentFileStatement.
    def exitCreateRestContentFileStatement(
        self, ctx: MRSParser.CreateRestContentFileStatementContext
    ):
        pass
    ...
    def enterCreateRestAuthAppStatement(
        self, ctx: MRSParser.CreateRestAuthAppStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestAuthAppStatement.
    def exitCreateRestAuthAppStatement(
        self, ctx: MRSParser.CreateRestAuthAppStatementContext
    ):
        pass
    ...
    def enterAllowNewUsersToRegister(
        self, ctx: MRSParser.AllowNewUsersToRegisterContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#allowNewUsersToRegister.
    def exitAllowNewUsersToRegister(
        self, ctx: MRSParser.AllowNewUsersToRegisterContext
    ):
        pass
    ...
    def enterCreateRestUserStatement(
        self, ctx: MRSParser.CreateRestUserStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestUserStatement.
    def exitCreateRestUserStatement(
        self, ctx: MRSParser.CreateRestUserStatementContext
    ):
        pass
    ...
    def enterCreateRestRoleStatement(
        self, ctx: MRSParser.CreateRestRoleStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#createRestRoleStatement.
    def exitCreateRestRoleStatement(
        self, ctx: MRSParser.CreateRestRoleStatementContext
    ):
        pass
    ...
    def enterCloneRestServiceStatement(
        self, ctx: MRSParser.CloneRestServiceStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#cloneRestServiceStatement.
    def exitCloneRestServiceStatement(
        self, ctx: MRSParser.CloneRestServiceStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#alterRestServiceStatement.
    def enterAlterRestServiceStatement(
        self, ctx: MRSParser.AlterRestServiceStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#alterRestServiceStatement.
    def exitAlterRestServiceStatement(
        self, ctx: MRSParser.AlterRestServiceStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#alterRestSchemaStatement.
    def enterAlterRestSchemaStatement(
        self, ctx: MRSParser.AlterRestSchemaStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#alterRestSchemaStatement.
    def exitAlterRestSchemaStatement(
        self, ctx: MRSParser.AlterRestSchemaStatementContext
    ):
        pass
    ...
    def enterAlterRestProcedureStatement(
        self, ctx: MRSParser.AlterRestProcedureStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#alterRestProcedureStatement.
    def exitAlterRestProcedureStatement(
        self, ctx: MRSParser.AlterRestProcedureStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#alterRestFunctionStatement.
    def enterAlterRestFunctionStatement(
        self, ctx: MRSParser.AlterRestFunctionStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#alterRestFunctionStatement.
    def exitAlterRestFunctionStatement(
        self, ctx: MRSParser.AlterRestFunctionStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#alterRestContentSetStatement.
    def enterAlterRestContentSetStatement(
        self, ctx: MRSParser.AlterRestContentSetStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#alterRestContentSetStatement.
    def exitAlterRestContentSetStatement(
        self, ctx: MRSParser.AlterRestContentSetStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#alterRestAuthAppStatement.
    def enterAlterRestAuthAppStatement(
        self, ctx: MRSParser.AlterRestAuthAppStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#alterRestAuthAppStatement.
    def exitAlterRestAuthAppStatement(
        self, ctx: MRSParser.AlterRestAuthAppStatementContext
    ):
        pass
    ...
    def enterDropRestServiceStatement(
        self, ctx: MRSParser.DropRestServiceStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#dropRestServiceStatement.
    def exitDropRestServiceStatement(
        self, ctx: MRSParser.DropRestServiceStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#dropRestSchemaStatement.
    def enterDropRestSchemaStatement(
        self, ctx: MRSParser.DropRestSchemaStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#dropRestSchemaStatement.
    def exitDropRestSchemaStatement(
        self, ctx: MRSParser.DropRestSchemaStatementContext
    ):
        pass
    ...
    def enterDropRestProcedureStatement(
        self, ctx: MRSParser.DropRestProcedureStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#dropRestProcedureStatement.
    def exitDropRestProcedureStatement(
        self, ctx: MRSParser.DropRestProcedureStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#dropRestFunctionStatement.
    def enterDropRestFunctionStatement(
        self, ctx: MRSParser.DropRestFunctionStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#dropRestFunctionStatement.
    def exitDropRestFunctionStatement(
        self, ctx: MRSParser.DropRestFunctionStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#dropRestContentSetStatement.
    def enterDropRestContentSetStatement(
        self, ctx: MRSParser.DropRestContentSetStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#dropRestContentSetStatement.
    def exitDropRestContentSetStatement(
        self, ctx: MRSParser.DropRestContentSetStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#dropRestContentFileStatement.
    def enterDropRestContentFileStatement(
        self, ctx: MRSParser.DropRestContentFileStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#dropRestContentFileStatement.
    def exitDropRestContentFileStatement(
        self, ctx: MRSParser.DropRestContentFileStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#dropRestAuthAppStatement.
    def enterDropRestAuthAppStatement(
        self, ctx: MRSParser.DropRestAuthAppStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#dropRestAuthAppStatement.
    def exitDropRestAuthAppStatement(
        self, ctx: MRSParser.DropRestAuthAppStatementContext
    ):
        pass
    ...
    def exitGrantRestPrivilegeStatement(
        self, ctx: MRSParser.GrantRestPrivilegeStatementContext
    ):
        pass
    ...
    def enterRevokeRestPrivilegeStatement(
        self, ctx: MRSParser.RevokeRestPrivilegeStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#revokeRestPrivilegeStatement.
    def exitRevokeRestPrivilegeStatement(
        self, ctx: MRSParser.RevokeRestPrivilegeStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#revokeRestRoleStatement.
    def enterRevokeRestRoleStatement(
        self, ctx: MRSParser.RevokeRestRoleStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#revokeRestRoleStatement.
    def exitRevokeRestRoleStatement(
        self, ctx: MRSParser.RevokeRestRoleStatementContext
    ):
        pass
    ...
    def enterServiceAndSchemaRequestPaths(
        self, ctx: MRSParser.ServiceAndSchemaRequestPathsContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#serviceAndSchemaRequestPaths.
    def exitServiceAndSchemaRequestPaths(
        self, ctx: MRSParser.ServiceAndSchemaRequestPathsContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#showRestMetadataStatusStatement.
    def enterShowRestMetadataStatusStatement(
        self, ctx: MRSParser.ShowRestMetadataStatusStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#showRestMetadataStatusStatement.
    def exitShowRestMetadataStatusStatement(
        self, ctx: MRSParser.ShowRestMetadataStatusStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#showRestServicesStatement.
    def enterShowRestServicesStatement(
    ...
    def enterShowRestSchemasStatement(
        self, ctx: MRSParser.ShowRestSchemasStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#showRestSchemasStatement.
    def exitShowRestSchemasStatement(
        self, ctx: MRSParser.ShowRestSchemasStatementContext
    ):
        pass
    ...
    def enterShowRestProceduresStatement(
        self, ctx: MRSParser.ShowRestProceduresStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#showRestProceduresStatement.
    def exitShowRestProceduresStatement(
        self, ctx: MRSParser.ShowRestProceduresStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#showRestFunctionsStatement.
    def enterShowRestFunctionsStatement(
        self, ctx: MRSParser.ShowRestFunctionsStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#showRestFunctionsStatement.
    def exitShowRestFunctionsStatement(
        self, ctx: MRSParser.ShowRestFunctionsStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#showRestContentSetsStatement.
    def enterShowRestContentSetsStatement(
        self, ctx: MRSParser.ShowRestContentSetsStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#showRestContentSetsStatement.
    def exitShowRestContentSetsStatement(
        self, ctx: MRSParser.ShowRestContentSetsStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#showRestContentFilesStatement.
    def enterShowRestContentFilesStatement(
        self, ctx: MRSParser.ShowRestContentFilesStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#showRestContentFilesStatement.
    def exitShowRestContentFilesStatement(
        self, ctx: MRSParser.ShowRestContentFilesStatementContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#showRestAuthAppsStatement.
    def enterShowRestAuthAppsStatement(
        self, ctx: MRSParser.ShowRestAuthAppsStatementContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#showRestAuthAppsStatement.
    def exitShowRestAuthAppsStatement(
        self, ctx: MRSParser.ShowRestAuthAppsStatementContext
    ):
        pass
    ...
    def enterServiceRequestPathWildcard(
        self, ctx: MRSParser.ServiceRequestPathWildcardContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#serviceRequestPathWildcard.
    def exitServiceRequestPathWildcard(
        self, ctx: MRSParser.ServiceRequestPathWildcardContext
    ):
        pass
    ...
    def enterSchemaRequestPathWildcard(
        self, ctx: MRSParser.SchemaRequestPathWildcardContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#schemaRequestPathWildcard.
    def exitSchemaRequestPathWildcard(
        self, ctx: MRSParser.SchemaRequestPathWildcardContext
    ):
        pass
    ...
    def enterObjectRequestPathWildcard(
        self, ctx: MRSParser.ObjectRequestPathWildcardContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#objectRequestPathWildcard.
    def exitObjectRequestPathWildcard(
        self, ctx: MRSParser.ObjectRequestPathWildcardContext
    ):
        pass
    ...
    def enterNewProcedureRequestPath(
        self, ctx: MRSParser.NewProcedureRequestPathContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#newProcedureRequestPath.
    def exitNewProcedureRequestPath(
        self, ctx: MRSParser.NewProcedureRequestPathContext
    ):
        pass
    ...
    def enterNewContentSetRequestPath(
        self, ctx: MRSParser.NewContentSetRequestPathContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#newContentSetRequestPath.
    def exitNewContentSetRequestPath(
        self, ctx: MRSParser.NewContentSetRequestPathContext
    ):
        pass
    ...
    def enterServiceDeveloperIdentifier(
        self, ctx: MRSParser.ServiceDeveloperIdentifierContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#serviceDeveloperIdentifier.
    def exitServiceDeveloperIdentifier(
        self, ctx: MRSParser.ServiceDeveloperIdentifierContext
    ):
        pass

    # Enter a parse tree produced by MRSParser#serviceDevelopersIdentifier.
    def enterServiceDevelopersIdentifier(
        self, ctx: MRSParser.ServiceDevelopersIdentifierContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#serviceDevelopersIdentifier.
    def exitServiceDevelopersIdentifier(
        self, ctx: MRSParser.ServiceDevelopersIdentifierContext
    ):
        pass
    ...
    def enterRequestPathIdentifierWithWildcard(
        self, ctx: MRSParser.RequestPathIdentifierWithWildcardContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#requestPathIdentifierWithWildcard.
    def exitRequestPathIdentifierWithWildcard(
        self, ctx: MRSParser.RequestPathIdentifierWithWildcardContext
    ):
        pass
    ...
    def enterIdentifierListWithParentheses(
        self, ctx: MRSParser.IdentifierListWithParenthesesContext
    ):
        pass

    # Exit a parse tree produced by MRSParser#identifierListWithParentheses.
    def exitIdentifierListWithParentheses(
        self, ctx: MRSParser.IdentifierListWithParenthesesContext
    ):
        pass
