...
- MariaDB Shell / MariaDB Shell for VS Code
...
1. A local development setup used to develop new REST services.
   - A local MariaDB Shell installation to connect to and execute REST SQL extension commands.
...
The recommended way to configure a MySQL REST Service development setup is to use [VS Code](https://code.visualstudio.com/) or [VSCodium](https://vscodium.com/) with the [MariaDB Shell for VS Code](https://marketplace.visualstudio.com/items?itemName=Oracle.mysql-shell-for-vs-code) extension installed. This will simplify things like HTTPS certificate installation and bootstrapping the MySQL Router in development mode.
